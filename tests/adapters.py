...
def run_scaled_dot_product_attention(
    ...
    """
    d_k = Q.shape[-1]
    sdpa = scaled_dot_product_attention(d_k=d_k, device=Q.device, dtype=Q.dtype)
...
def run_multihead_self_attention(
    ...
    return mha(in_features=in_features)
...
def run_multihead_self_attention_with_rope(
    ...
    return mha_with_rope(in_features=in_features, token_positions=token_positions)
...
def run_transformer_block(
    ...
    transformer_block.load_state_dict({
        ...
        "attn.out_proj": weights["attn.output_proj.weight"],
    ...
    return transformer_block(x=in_features, token_positions=token_positions)
...
def run_transformer_lm(
    ...
    transformer_lm.load_state_dict({
        ...
        **{
            f'layers.{i}.attn.Q_proj': weights[f'layers.{i}.attn.q_proj.weight']
            for i in range(num_layers)
        },
        **{
            f'layers.{i}.attn.K_proj': weights[f'layers.{i}.attn.k_proj.weight']
            for i in range(num_layers)
        },
        **{
            f'layers.{i}.attn.V_proj': weights[f'layers.{i}.attn.v_proj.weight']
            for i in range(num_layers)
        },
        **{
            f'layers.{i}.attn.out_proj': weights[f'layers.{i}.attn.output_proj.weight']
            for i in range(num_layers)
        },
        **{
...
def get_tokenizer(
    ...
    """
    bpe_tokenizer = BPETokenizer(vocab=vocab, merges=merges, special_tokens=special_tokens)
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    return bpe_tokenizer.bpe_train(
